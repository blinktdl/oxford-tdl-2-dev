		...
		value: function goToLessonMenu(unitNumber) {
			...
			if (selectedUnit) {
				...
				if (!hasLessons && hasResources) {
					this.goToPlusZoneCategoriesMenu(unitNumber);
				} else {
